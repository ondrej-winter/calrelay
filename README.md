...
CalRelay is planned as a local macOS Swift CLI that uses Apple Calendar/EventKit-visible calendars to relay availability blockers across multiple work calendars.
