...
public enum SettingsValidator {
    ...
    private static func validateHubCalendar(_ selector: CalendarSelector) throws {
        guard !selector.sourceTitle.isEmpty else { throw SettingsValidationError.emptyHubCalendarSourceTitle }

        guard !selector.calendarTitle.isEmpty else { throw SettingsValidationError.emptyHubCalendarTitle }
    }
