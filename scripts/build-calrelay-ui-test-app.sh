...
APP_NAME="CalRelayUITestHost"
EXECUTABLE_NAME="CalRelayApp"
BUILD_DIR="${ROOT_DIR}/.build/${CONFIGURATION}"
WORKSPACE_KEY="$(printf '%s' "${ROOT_DIR}" | /usr/bin/shasum -a 256 | /usr/bin/cut -d ' ' -f 1)"
BUNDLE_DIR="${HOME}/Library/Caches/dev.owinter.CalRelay/ui-test-builds/${WORKSPACE_KEY}"
...
cp "${ROOT_DIR}/Resources/CalRelayUITestHost/Info.plist" "${CONTENTS_DIR}/Info.plist"
