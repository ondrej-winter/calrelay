...
@Suite("Configuration file selection tests") struct ConfigurationFileSelectionTests {
    @Test("No override selects canonical path under injected home directory") func noOverrideSelectsDefaultPath() throws
    {
    ...
    @Test("Explicit override selects provided path instead of default") func explicitOverrideSelectsProvidedPath()
        throws
    {
        let homeDirectory = URL(fileURLWithPath: "/Users/example", isDirectory: true)
